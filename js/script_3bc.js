...
$(".m_close").click(function(){
    ...
    $("html").removeClass(".m_nav_open")/*스크롤*/
})
...
$(window).scroll(function(){
    ...
    if(scrTop>30){
        ...
        $(".logo img").attr("src","img/1x/logo2_.png")
        $(".h_icons_a img").attr("src","img/1x/home2.png")
        $(".h_icons_b img").attr("src","img/1x/menu2.png")
    
    }else{       
         $(".header").removeClass("fixed")
         $(".logo img").attr("src","img/1x/logo1.png")
         $(".h_icons_a img").attr("src","img/1x/home1.png")
         $(".h_icons_b img").attr("src","img/1x/menu1.png")
    }
})
